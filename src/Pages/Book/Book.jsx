...
const Book = ({book}) => {
    console.log(book);
    const {bookName,author,category,image,publisher,rating,review,totalPages,yeaOfPublishing,tags} = book
        ...
        <div className="card bg-base-100 shadow-xl p-6">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-between py-3 items-center">
                    ...
                    <div className="flex border rounded px-2"> <User></User> Author:  {author.slice(0,10)}</div>
                </div>
            </div>
        </div>
    );
